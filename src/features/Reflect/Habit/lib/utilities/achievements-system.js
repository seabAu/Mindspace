...
import { calculateHabitStreak } from "./rewards-system";
 ...
 */
export const calculateAchievementTier = ( achievementKey, currentValue ) => {
 ...
 */
export const getNextTierRequirement = ( achievementKey, currentTier ) => {
  const achievement = ACHIEVEMENT_DEFINITIONS[ achievementKey ];
 ...
 */
export const checkAndAwardAchievements = ( habits = [] ) => {
 ...
 */
export const calculateUserStats = ( userData, habits ) => {
  const now = new Date();
 ...
 */
export const getAchievementProgress = ( achievementKey, currentValue ) => {
  const achievement = ACHIEVEMENT_DEFINITIONS[ achievementKey ];
 ...
 */
export const getUserLevelProgress = ( totalPoints ) => {
