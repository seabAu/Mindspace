...
// Dashboard specific help FAQ page.
export default function HelpDropdown () {
    return (
        <Dialog>
            <DialogTrigger asChild>
                {/* <Button variant="outline" className={ `size-full aspect-square` } size='icon'> */ }
                <MessageCircleQuestionIcon className={ `size-8 aspect-square` } />
                {/* </Button> */ }
            </DialogTrigger>
            <DialogContent className="flex flex-col gap-0 p-0 sm:max-h-[min(640px,80vh)] sm:max-w-lg [&>button:last-child]:top-3.5 overflow-auto">
                <DialogHeader className="contents space-y-0 text-left">
                    <DialogTitle className="border-b border-border px-6 py-4 text-base">
                        Frequently Asked Questions (FAQ)
                    </DialogTitle>
                    <div className="overflow-y-auto">
                        <DialogDescription asChild className={ `w-full h-full` }>
