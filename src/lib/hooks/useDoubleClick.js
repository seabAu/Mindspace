// Imported copy of use-double-click from https://github.com/tim-soft/use-double-click/blob/master/src/index.js //
...
const useDoubleClick = ( {
    ...
    useEffect( () => {
        ...
        if ( clickRef ) clickRef.addEventListener( 'click', handleClick );
