            ...
            <div className="wrapper">
                ...
                <div className="main-container">
                    ...
                    <div className="user-box first-box">
                        <div className="activity card" style={ { delay: `0.2s` } }>
                        ...
                        <div className="discount card delay-[0.4s]">
                        ...
                        <div className="cards-wrapper" style={ { delay: `0.6s` } }>
                            ...
                            <div className="cards card">
                                <div className="cards-head">
                                    <div className="cards-info">
                                        <div className="calendar-hour">08.20 <span className="am-pm">pm</span>
                                        </div>
                        ...
                        <div className="account-wrapper" style={ { delay: `0.8s` } }>
                        ...
                        <div className="cards-wrapper" style={ { delay: '1s' } }>
                            <div className="cards-header">
                                <div className="cards-view">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-calendar">
                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-activity">
