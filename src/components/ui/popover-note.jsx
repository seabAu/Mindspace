...
function PopoverNote ( { note, setNote, handleSaveNote, handleClearNote, handleCopyNote } ) {
    const uniqueId = useId();
    const formContainerRef = useRef( null );
    const [ isOpen, setIsOpen ] = useState( false );
    const [ noteContent, setNoteContent ] = useState( note ?? null );
    ...
    const closeMenu = () => {
        // Save current value, then clear what's stored locally.
        setIsOpen( false );
        setNoteContent( null );
    };
