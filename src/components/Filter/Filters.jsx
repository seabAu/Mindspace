// https://21st.dev/andrewlu0/filters/default // 
...
/*  
    ...
    name | Status | Assignee | Labels | Priority | DueDate;
...
export const statusFilterOptions = Object.values( Status ).map(
    ( status ) => ( {
        name: status,
...
export const assigneeFilterOptions = Object.values(
    Assignee
).map( ( assignee ) => ( {
    name: assignee,
...
export const labelFilterOptions = Object.values( Labels ).map(
    ( label ) => ( {
        name: label,
...
export const priorityFilterOptions = Object.values(
    Priority
).map( ( priority ) => ( {
    name: priority,
...
export const dateFilterOptions = Object.values( DueDate ).map(
    ( date ) => ( {
        name: date,
        icon: undefined,
    } )
